...
- `ar_regtrend_price`: rather than allowing the algorithm to select from the 11 price variables, we use only the price relevant to each brand. This is to guard against possible overfitting, something that classical stepwise procedures are wont to do.
...
save_objects(oj_trainreg, oj_testreg,
             example="oj_retail", file="data_reg.Rdata")
...
save_objects(oj_modelset_reg, oj_fcast_reg,
             example="oj_retail", file="model_reg.Rdata")
...
We can see that the models incorporating price are a significant improvement over the previous naive models.
